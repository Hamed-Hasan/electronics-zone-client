...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#1F2937" fillOpacity="1" d="M0,192L48,165.3C96,139,192,85,288,96C384,107,480,181,576,197.3C672,213,768,171,864,149.3C960,128,1056,128,1152,138.7C1248,149,1344,171,1392,181.3L1440,192L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path></svg>
...
<img src={logo} className=" mr-12 w-28 my-0" alt="logo" />
...
<ul className="text-gray-300">
<li className="mb-4">
<a href="https://github.com/hamed-hasan" className="hover:underline">Github</a>
</li>
<li className="mb-4">
<a href="https://www.facebook.com/" className="hover:underline">Facebook
...
<span className="text-sm text-gray-300 sm:text-center">© 2022 <a href="https://landing-pages-portfolio.netlify.app">Hamed Hasan™</a>. All Rights Reserved.
</span>
...
<a href="https://github.com/hamed-hasan" className="text-gray-400 hover:text-white">
