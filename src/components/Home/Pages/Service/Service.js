...
const Service = ({ service }) => {
  ...
  return (
    <div>
      <div
        style={{ height: "100%" }}
        className="home-card gradient-border w-full hover:-translate-y-5 transition-all bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700"
      >
        <a href="#">
