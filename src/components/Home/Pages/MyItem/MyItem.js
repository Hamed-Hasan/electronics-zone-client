...
<div id='item-card' class="w-full mt-24">
    <div>
     ...
     <div class="bg-green-100 flex items-center my-8 w-44 justify-center text-center text-green-800 text-sm font-bold mr-2 px-2.5 py-0.5 rounded dark:bg-green-200 dark:text-green-900 ">My Total Item {myItem.length} 
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4m0 5c0 2.21-3.582 4-8 4s-8-1.79-8-4" />
    ...
    <div class="bg-white font-semibold text-center rounded-3xl border shadow-lg p-10 w-full transform transition duration-500 hover:scale-110">
     ...
     <button onClick={() => handleDelete(item._id)} class="bg-amber-600 hover:bg-amber-900 flex items-center justify-center w-52 mx-auto px-8 py-2 mt-8 rounded-3xl text-gray-100 font-semibold uppercase tracking-wide">Delete Item
