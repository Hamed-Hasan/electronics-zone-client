                ...
                <div key={item._id}>
                  <div className="bg-white font-semibold text-center rounded-3xl border shadow-lg p-10 w-full transform transition duration-500 hover:scale-110">
                    ...
                    <button
                      ...
                      className="bg-amber-600 hover:bg-amber-900 flex items-center justify-center  mx-auto px-8 md:px-4 lg:px-8 py-2 mt-8 rounded-3xl text-gray-100 font-semibold uppercase tracking-wide"
                    >
                      Delete Item
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
